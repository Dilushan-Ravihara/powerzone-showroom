...
<div class="category-page-wrapper container py-5">
    <div class="text-center mb-5">
        <h1 class="section-title">Household Appliances</h1>
        <p class="section-subtitle text-muted">Make your home more comfortable, efficient, and modern</p>
    </div>
    ...
    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 g-4" id="Product-list">
        ...
        ?>
            <div class="col-12 text-center py-5">
                ...
                <p class="text-muted">No household appliances found in inventory.</p>
            </div>
        <?php endif; ?>
    </div>
</div>
